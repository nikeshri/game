...
class Heli:public Timer         ///CLASS hamile heli leko chau
{
    private:
...
void Heli::move()
{
    ...
    ///helicopter chalauna lai
    box.y += yVel;
    boom=Mix_LoadWAV("sound/boom.wav");         ///sound ko lagi


    for(int i=0;i<7;++i)                
    {
        ///helicopter para gaera crash vako ma ho 
